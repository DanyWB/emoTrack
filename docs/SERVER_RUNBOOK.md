...
```bash
grep -nE '^(NODE_ENV|PORT|REDIS_URL|REDIS_ENABLED|JOBS_ENABLED|TELEGRAM_MODE|TELEGRAM_STARTUP_TIMEOUT_MS|ADMIN_TELEGRAM_IDS|SUPPORT_URL|DEFAULT_TIMEZONE|NODE_OPTIONS)=' .env
