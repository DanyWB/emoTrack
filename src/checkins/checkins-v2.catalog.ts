...
export const CHECKIN_V2_METRICS: CheckinV2MetricDefinition[] = [
  ...
  },
  {
    ...
    tags: [
      ...
      { key: 'energy_unclear', label: 'непонятно', family: 'unclear', polarity: 'mixed' },
    ],
  },
  {
    key: 'calm',
    ...
    tags: [
      ...
      { key: 'calm_peaceful', label: 'есть опора', family: 'grounding', polarity: 'positive' },
      { key: 'calm_safe', label: 'в безопасности', family: 'safety', polarity: 'positive' },
      ...
      { key: 'calm_chaotic', label: 'на взводе', family: 'hyperarousal', polarity: 'negative' },
      { key: 'calm_pressured', label: 'под давлением', family: 'pressure', polarity: 'negative' },
      { key: 'calm_unclear', label: 'непонятно', family: 'unclear', polarity: 'mixed' },
    ],
  },
  {
    key: 'motivation',
    ...
    tags: [
      ...
      { key: 'motivation_unclear', label: 'непонятно', family: 'unclear', polarity: 'mixed' },
    ],
  },
  {
    key: 'overall_state',
    ...
    tags: [
      { key: 'overall_light', label: 'ресурсно', family: 'resources', polarity: 'positive' },
      ...
      { key: 'overall_limit', label: 'на пределе', family: 'limit', polarity: 'negative' },
      { key: 'overall_broken', label: 'опустошенно', family: 'emptiness', polarity: 'negative' },
  ...
  },
  {
    ...
    tags: [
      { key: 'clarity_clear', label: 'легко думать', family: 'clarity', polarity: 'positive' },
      { key: 'clarity_collected', label: 'мысли упорядочены', family: 'organization', polarity: 'positive' },
      ...
      { key: 'clarity_looping', label: 'зацикленность', family: 'rumination', polarity: 'negative' },
      { key: 'clarity_foggy', label: 'туман в голове', family: 'fog', polarity: 'negative' },
      ...
      { key: 'clarity_unclear', label: 'непонятно', family: 'unclear', polarity: 'mixed' },
    ],
  },
  {
    key: 'social',
    ...
    tags: [
      ...
      { key: 'social_support', label: 'хочется поддержки', family: 'support', polarity: 'positive' },
      ...
      { key: 'social_unclear', label: 'непонятно', family: 'unclear', polarity: 'mixed' },
    ],
  },
  {
    key: 'physical_state',
    ...
    tags: [
      ...
      { key: 'physical_weakness', label: 'слабость', family: 'weakness', polarity: 'negative' },
      { key: 'physical_tension', label: 'напряжение в теле', family: 'tension', polarity: 'negative' },
      { key: 'physical_stiffness', label: 'скованность', family: 'tension', polarity: 'negative' },
      { key: 'physical_discomfort', label: 'дискомфорт', family: 'discomfort', polarity: 'negative' },
      { key: 'physical_unclear', label: 'непонятно', family: 'unclear', polarity: 'mixed' },
    ],
  },
];
