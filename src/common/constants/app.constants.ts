...
export const TELEGRAM_CALLBACKS = {
  ...
  checkinMetricTagsTogglePrefix: 'checkin:metric-tags:toggle:',
  checkinReviewConfirm: 'checkin:review:confirm',
  checkinReviewEdit: 'checkin:review:edit',
  checkinReviewEditPrefix: 'checkin:review:edit:',
  checkinV2OnboardingNext: 'checkin:v2-onboarding:next',
  checkinV2OnboardingStart: 'checkin:v2-onboarding:start',
  ...
  statsBackToPeriods: 'stats:periods',
